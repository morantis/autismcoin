...
#if defined(NDEBUG)
# error "AutismCoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xa4b74cbd2d782275e43a80e02a6dd030b1ad368cf0dceba6f8045eb2378cff9a");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // AutismCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "AutismCoin Signed Message:\n";
...
{
    // AutismCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // AutismCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // AutismCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa4b74cbd2d782275e43a80e02a6dd030b1ad368cf0dceba6f8045eb2378cff9a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1449258124, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "Coldplay to headline Super Bowl halftime show";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("047c2999db57ad85c62092cec7938976864c797229909f0d7b9e4ff5d11f17d6c06454ab97f0250332610f00c0006bc284baf0e78c00064d54cefe086ef2dadf0c") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1449258124;
        ...
        assert(block.hashMerkleRoot == uint256("0x7d62412507d73d92c56fa519402a0d34e1d64c9399ba02d302cb170e612df801"));
...
unsigned char pchMessageStart[4] = { 0xed, 0x1e, 0x77, 0x10 }; // AutismCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AutismCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AutismCoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static AutismCoinMiner(CWallet *pwallet)
{
    printf("AutismCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("autismcoin-miner");
    ...
    try { loop {
        ...
        printf("Running AutismCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("AutismCoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&AutismCoinMiner, pwallet));
}
